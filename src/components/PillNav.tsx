...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="absolute left-1/2 top-[1em] z-[1000] w-full -translate-x-1/2 px-4 md:w-max md:px-0">
      <nav
        className={`mx-auto flex w-max items-center justify-center box-border ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
        <Link
        ...
        <button
          ...
          className="relative flex flex-col items-center justify-center gap-1 rounded-full border-0 p-0 cursor-pointer md:hidden"
          style={{
            width: "var(--nav-h)",
            height: "var(--nav-h)",
            background: "var(--base, #000)",
